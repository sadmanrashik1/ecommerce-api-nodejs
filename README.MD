...
**Script**: `./autoTestsBash/test-api.sh`  
**Purpose**: automated end-to-end testing of the E-Commerce API using **bash + curl + jq**.  
**Runs on**: Linux, macOS, Windows (cygWin, WSL or Git Bash)
